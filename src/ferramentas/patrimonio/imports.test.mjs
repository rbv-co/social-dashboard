...
//
// A dor desta pasta (10/08/2026): `linhasAchatadas` chamava `formatarDataBR`
// — que existe e é exportada por `patrimonio-lista.js` — sem nunca ter sido
// importada. As abas Planilha e Resumo marcavam e abriam EM BRANCO; Navegar e
// Etiquetas seguiam funcionando, o que fez o defeito parecer coisa de layout.
